...
<body>
    <div class="form-container">
        <h2><i class="fas fa-file-alt"></i> Tambah Form</h2>
        ...
        <form method="POST" id="formForm">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" required placeholder="Masukkan judul form">
            </div>

            <div class="form-group">
                <label for="url">
                    <i class="fas fa-globe"></i> URL Form
                </label>
                <input type="url" id="url" name="url" required placeholder="https://forms.google.com/...">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" placeholder="Deskripsi form"></textarea>
            </div>
