...
$categoryKey = 'dokumentasi';
$categorySlug = basename(__FILE__, '.php');
$categoryName = 'Dokumentasi';
$categoryIcon = 'fa-photo-video';
$categoryColor = '#f97316';
$folderId = defined('FOLDER_DOKUMENTASI') ? FOLDER_DOKUMENTASI : '';
$sheetId = defined('SHEETS_DOKUMENTASI') ? SHEETS_DOKUMENTASI : '';
...
<head>
    ...
    <style>
        ...
        .section-header h2 { margin: 0; font-size: 1.25rem; color: var(--dark-color); display: flex; align-items: center; gap: 0.5rem; }
        
        .filter-bar { display: grid; grid-template-columns: 1fr auto auto; gap: 0.75rem; margin-bottom: 1rem; }
        .filter-bar input, .filter-bar select { padding: 0.5rem 0.75rem; border: 1px solid var(--border-color); border-radius: 0.375rem; font-size: 0.875rem; }
...
<body>
        ...
        <div class="content-wrapper">
            <div class="category-header">
                ...
                <div>
                    ...
                    <p style="margin: 0; opacity: 0.9;">Dokumentasi dan koleksi media</p>
                </div>
            </div>
    ...
    <script>
        ...
        // Pagination state defaults (declared early to avoid TDZ when reload* called)
    ...
    <script>
        ...
        // Links pagination state (already declared earlier)
        linksPage = linksPage || 1;
        linksPerPage = linksPerPage || 10;
        linksHasMore = linksHasMore || false;
        ...
        formsPage = formsPage || 1;
        formsPerPage = formsPerPage || 10;
        formsHasMore = formsHasMore || false;
        ...
        // Legacy function - redirects to new batch upload
        ...
        // Init pagination and lazy load data (server-side pagination for files)
        CATEGORY_FILES_PER_PAGE = CATEGORY_FILES_PER_PAGE || 15;
        categoryFilesPage = categoryFilesPage || 1;
        categoryFilesTokens = categoryFilesTokens || {1: ''};
        categoryFilesHasMore = categoryFilesHasMore || false;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // per-page selector is rendered inside the pagination controls for consistent styling
            ...
            // Mobile pagination label adjustments
