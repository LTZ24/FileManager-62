...
$categoryKey = 'kesiswaan';
$categoryName = 'Kesiswaan';
$categoryIcon = 'fa-user-graduate';
$categoryColor = '#3b82f6';
$folderId = '1ek7EDGg525Nr6sT30yNhyLvphgXGN-3z';
        ...
        <div class="content-wrapper">
            ...
            <div class="section-container">
                ...
                <div class="filter-bar">
                    ...
                    <select id="sortFiles" onchange="sortFiles()" style="padding: 0.5rem 0.75rem; border: 1px solid var(--border-color); border-radius: 0.375rem; font-size: 0.875rem;">
